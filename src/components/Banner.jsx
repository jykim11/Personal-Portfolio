							...
							{({ isVisible }) => (
								...
								>
									...
									>
										...
										stack and mobile application development 🧑🏻‍💻. I
										strive for perfection to create user friendly,
										intuitive applications that are both visually
										appealing as well as functional for the end users
										needs.
									</p>
									<div className="cta">
